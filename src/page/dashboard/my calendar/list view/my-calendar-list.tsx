      ...
      <div className="calendar-list-view pt-2">
        <div className="main bg-[#fafafa] p-4 rounded-md text-sm">
          ...
          <div className="mt-2">
            ...
            {/* View All Button */}
            <div className="mt-4">
              <Button className="px-4 text-xs font-medium rounded h-8 border-2 border-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-border text-transparent bg-clip-text">
                View all
              </Button>
            </div>
          </div>
