...
function GenerativeSidebar() {
  ...
  return (
    <>
      <div className="generative-sidebar p-2 fixed h-full ">
        <div className="main">
            ...
            <nav className="space-y-4">
              ...
              <div className="relative w-full">
                ...
                <div
                  ...
                  style={{
                    height:
                      (favoriteOpen ? 100 : 0) + (recentlyOpen ? 100 : 0) + "px",
                  }}
                ></div>
                <div
                  ...
                  <div className="pl-1 mt-4 space-y-3">
                    ...
                    <div className="relative w-full">
                      ...
                      >
                        ...
                        <ChevronRight
                          className={`w-4 h-4 transform transition-transform duration-300 ${
                            recentlyOpen ? "rotate-90" : ""
                          }`}
                        />
                      </div>
                      <div
                        className={`pl-8 mt-1 text-sm space-y-2 transition-all duration-300 ${
                          recentlyOpen
                            ? "max-h-screen pt-1"
