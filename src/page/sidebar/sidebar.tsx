          ...
          <div className="text-sm">
            {location.pathname === "/business-setting" ? (
                  ...
                  <div className="pl-1 mt-4 space-y-3">
                    <div className="relative w-full">
                      <div className="flex items-center justify-between cursor-pointer w-full">
                        <div
                          className={`flex items-center gap-1 font-medium ${active === "/favorite/contracts" ? "text-black" : ""
                            }`}
                        >
                    ...
                    <div className="relative w-full">
                      ...
                      >
                        <div
                          className={`flex items-center gap-1 font-medium ${active === "/favorite/recently-accessed"
                            ? "text-black"
                            : ""
                            }`}
                        >
              ...
              : location.pathname === "/business-area" ? (
                ...
                <div
                  className={`space-y-3 ${location.pathname.includes("/business-area")
                    ? "hidden"
                    : "block"
                    } `}
                >
                  ...
                  <div className="font-medium">
                    <Link
                      to="/"
                      className={`flex items-center gap-2 ${active === "/" ? "text-black" : "text-gray-500"
                        }`}
                      onClick={() => setActive("/")}
                    >
                  ...
                  <div className="font-medium">
                    <Link
                      to="/calendar"
                      className={`flex items-center gap-2 ${active === "/calendar" ? "text-black" : "text-gray-500"
                        }`}
                      ...
                      <div className="pl-1 mt-4 space-y-3">
                        ...
                        <div className="relative w-full">
                          ...
                          >
                            <Link
                              to="/contracts"
                              className={`flex items-center gap-1 font-medium ${active === "/favorite/contracts"
                                ? "text-black"
                                : ""
                                }`}
                            >
                        ...
                        <div className="relative w-full">
                          ...
                          >
                            <Link
                              to="/documents"
                              className={`flex items-center gap-1 font-medium ${active === "/favorite/documents"
                                ? "text-black"
                                : ""
                                }`}
                            >
