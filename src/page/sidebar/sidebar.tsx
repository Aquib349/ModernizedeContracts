          ...
          <div className="text-sm">
            {location.pathname === "/business-setting" ?
              ...
              : location.pathname === "/business-area" ? (
                ...
                <div className={`space-y-3 ${location.pathname.includes('/business-area') ? "hidden" : "block"} `}>
                  {/* My Work */}
                      ...
                      <div className="pl-1 mt-4 space-y-3">
                        ...
                        <div className="relative w-full">
                          ...
                          >
                            <Link
                              to="/documents"
                              className={`flex items-center gap-1 font-medium ${active === "/favorite/documents" ? "text-black" : ""
                                }`}
                            >
                              <Minus className="text-slate-200" />
                              My Documents
