...
function BusinessAreaDashboard() {
  ...
  return (
    <>
      <div className="contract-summary space-y-2 text-sm w-[70%] mx-auto">
        ...
        <div className="bg-gray-50 p-4 rounded-md">
          ...
          <div className=" text-gray-500  mt-4">
            <div className=" text-slate-500 font-semibold flex items-center gap-1 border-b border-gray-200 pb-1">
              Recent Activity
            </div>
            <div className="flex items-center gap-x-3 text-sm mt-2">
