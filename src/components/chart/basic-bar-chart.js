...
const Basicbarchart = () => {
    ...
    return (_jsx("div", { className: "app", children: _jsx("div", { className: "row", children: _jsx("div", { className: "mixed-chart", children: _jsx(ReactApexChart, { options: chartData.options, series: chartData.series, type: "bar", width: "500" }) }) }) }));
};
